! function(e, s, i) {
    ...
    i(s).on('click', '.remove-second-parent', function(){
        i(this).parent().parent().remove()
    })
    ...
    i(s).on("click", ".add-product-item", function() {
        i('<tr>' + emptyProductRow + '</tr>').insertBefore('#product-line-separator')
    });
