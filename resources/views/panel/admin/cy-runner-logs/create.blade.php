            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('admin/ui.add') }} CyRunner Log</h5>
                            <span>{{ __('admin/ui.add_a_new_record_for') }} CyRunner Log</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('admin/ui.create') }} CyRunner Log</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.cy-runner-logs.store') }}" method="post"
